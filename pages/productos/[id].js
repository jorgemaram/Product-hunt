...
const Producto = () => {
    ...
    const { nombre, comentarios, creado, descripcion, empresa, creador, url, urlimagen, votos, haVotado } = producto
    ...
    const votarProducto = () => {
        ...
        guardarConsultarDB(true);//hay un voto, consultar nuevamente a la BD
    }
