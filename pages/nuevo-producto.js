...
const NuevoProducto = () => {
    ...
    async function crearProducto() {
        ...
        //crear objeto de un nuevo producto
        const producto = {
            nombre,
            empresa,
            url,
                        ...
                        <Formulario onSubmit={handleSubmit} noValidate>
                            <fieldset>
                                ...
                                <Campo>
                                    ...
                                    <input type='text' id='empresa' placeholder='Nombre de la empresa' name='empresa' value={empresa} onChange={handleChange} onBlur={handleBlur} />
                                </Campo>
                                {errores.empresa && <Error>{errores.empresa}</Error>}
                                <Campo>
                                    <label htmlFor='imagen'>Imagen</label>
                                    <FileUploader accept='image/*' id='imagen' name='imagen' randomizeFilename storageRef={firebase.storage.ref('productos')} onUploadStart={handleUploadStart} onUploadError={handleUploadError} onUploadSuccess={handleUploadSuccess} onProgress={handleProgress} />
                                </Campo>
                                {errores.imagen && <Error>{errores.empresa}</Error>}
                                <Campo>
